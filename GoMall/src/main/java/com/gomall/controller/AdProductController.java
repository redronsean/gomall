...
import com.gomall.service.AdProductService;
import com.gomall.util.FileUtils;
import com.gomall.util.PageMaker;
...
public class AdProductController {
	...
	//  "/admin/product/subCGList/" + 1000;
	// 주소가 경로 들어왔을 때에 경로의 한 부분을 데이터로 참조하고자 하는 어노테이션 @PathVariable
	// 리턴값을 json으로 사용하기 위해서는 필수 라이브러리가 필요.
