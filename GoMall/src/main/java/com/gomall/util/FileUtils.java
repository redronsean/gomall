...
public class FileUtils {
	 ...
	 * 파일 업로드
	 * 
	 * @Params String uploadPath: 기본 파일 업로드 경로 String originName: 원본 파일명 byte[]
	 * fileData: 파일 데이터
	 * 
	 * @return String uploadedFileName : 날짜 경로 + 파일 이름
	 * (ex.\\2020\\03\\13\\uuid+fileName)
	 * 
	 */
	 ...
	 * 날짜 폴더 경로 설정 메소드
	 * 
	 * @Params uploadPath : 기본 파일 업로드 경로
	 * 
	 * @return String : 생성된 날짜 폴더 경로(ex.\\2020\\03\\03)
	 * 
	 */
	 ...
	 * 폴더 생성 메소드
	 * 
	 * @Params String uploadPath : 기본 파일 업로드 폴더 경로 String... paths : 생성할 폴더 경로들
	 * 
	 */
	 ...
	 * 이미지 파일의 썸네일 생성 메소드
	 * 
	 * @Params String uploadPath : 기본 파일 업로드 경로 String path : 날짜 경로 String fileName
	 * : UUID_originName
	 * 
	 * @return String : 날짜 경로 +s_ +fileName ex)\\2020\\03\\13\\uuid+s_+fileName
	 * 
	 */
	...
	/*
	 * 파일 가져옴 웹 프로젝트 외부 영역의 파일을 가져와 ResponseEntity로 반환
	 * 
	 * @Params String uploadPath : 외부 폴더 업로드 경로 String fileName : 가져올 파일 명
	 * 
	 * @return ResponseEntity<byte[]> : 가져온 파일 정보와 Http상태코드를 반환
	 * 
	 */
	 ...
	 * 이미지 파일 삭제
	 * 
	 * @Params String uploadPath : 파일 경로 String fileName : 삭제할 파일
	 * 
	 */
	...
	/*
	 * 썸네일 파일명 -> 원래 파일명 ex) /2020/03/20/s_UUID파일명 -> /2020/03/20/UUID파일명
	 */
